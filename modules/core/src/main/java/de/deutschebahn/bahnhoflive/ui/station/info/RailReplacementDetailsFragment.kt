...
class RailReplacementDetailsFragment :
    RecyclerFragment<RailReplacementDetailsAdapter>(R.layout.fragment_recycler_linear),
    MapPresetProvider {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.setAdapter(RailReplacementDetailsAdapter(
            serviceContents,
...
//        }
    ...
    companion object {
        ...
        fun create(
            ...
            title: CharSequence,
            trackingTag: String
        ): RailReplacementDetailsFragment {
            val fragment = RailReplacementDetailsFragment()
    ...
    override fun prepareMapIntent(intent: Intent) = false // todo
