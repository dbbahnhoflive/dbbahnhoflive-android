...
class FavoritesAdapter extends RecyclerView.Adapter<ViewHolder<StationWrapper>> {
    ...
    public FavoritesAdapter(InternalStation station, FavoriteStationsStore<InternalStation> favoriteStationsStore,
    ...
    private StationWrapper find(List<StationWrapper<InternalStation>> stationWrappers, InternalStation station, StationImageResolver stationImageResolver, FavoriteStationsStore<InternalStation> favoriteStationsStore) {
