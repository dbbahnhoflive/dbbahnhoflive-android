    ...
    private ViewHolder<MarkerBinder> createViewHolder(ViewGroup parent, MarkerContent.ViewType contentViewType) {
        switch (contentViewType) {
            ...
            case RAIL_REPLACEMENT:
                return new RailReplacementFlyoutViewHolder(parent, stationActivityStarter, EquipmentID.RAIL_REPLACEMENT);
            case LOCKERS:
                return new LockerFlyoutViewHolder(parent, stationActivityStarter, EquipmentID.LOCKERS);
            case COMMON:
            default:
                return new CommonFlyoutViewHolder(parent, mapViewModel, stationActivityStarter,  EquipmentID.UNKNOWN);
        }
    }
